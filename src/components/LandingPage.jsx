...
const EnhancedLandingPage = () => {
  ...
  return (
    <div className="h-screen bg-white overflow-hidden relative">
      ...
      <div 
        className="fixed w-6 h-6 rounded-full pointer-events-none transition-all duration-300 ease-out z-50 bg-black/5"
        style={{
      ...
      <div className="relative z-10 h-full flex flex-col">
        <div className="flex-1 flex items-center justify-center px-6">
          <div className={`text-center max-w-md mx-auto transition-all duration-700 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            ...
            <div className="relative mx-auto w-48 h-48 md:w-56 md:h-56 flex items-center justify-center mb-8">
              ...
              <div className={`absolute text-6xl md:text-7xl font-light text-gray-900 d-animation ${animationComplete ? 'completed' : ''}`}>
                D
              </div>
              
              {/* J letter with clean styling */}
              <div className={`absolute text-6xl md:text-7xl font-light text-gray-900 j-animation ${animationComplete ? 'completed' : ''}`}>
                J
              </div>
            ...
            <div className={`space-y-4 transition-opacity duration-700 ${animationComplete ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <p className="text-gray-600 font-light tracking-wide">Full Stack Developer • Problem Solver • Digital Creator</p>
            </div>

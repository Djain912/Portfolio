        ...
        <div className="gap-2 grid grid-cols-1 sm:grid-cols-2">
          ...
          <div className="flex flex-col items-center mt-6 gap-2" data-aos="fade-right">
            ...
            <div className="flex gap-6 text-3xl">
              <a href="https://github.com/Djain912" target='_blank' rel="noopener noreferrer" className="text-4xl text-[#00FFFF] hover:text-white transition-colors duration-200">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/darshanjain912/" target='_blank' rel="noopener noreferrer" className="text-4xl text-[#00FFFF] hover:text-white transition-colors duration-200">
                <FaLinkedin />
              </a>
              <a href="https://x.com/djain93260" target='_blank' rel="noopener noreferrer" className="text-4xl text-[#00FFFF] hover:text-white transition-colors duration-200">
                <FaTwitter />
              </a>
              <a href="https://wa.me/9321176546" target='_blank' rel="noopener noreferrer" className="text-4xl text-[#00FFFF] hover:text-white transition-colors duration-200">
                <FaWhatsapp />
              </a>
              <a href="https://www.instagram.com/darshanjain912?igsh=Y2tpa2NqMmhneWFv" target='_blank' rel="noopener noreferrer" className="text-4xl text-[#00FFFF] hover:text-white transition-colors duration-200">
                <FaInstagram />
              </a>
